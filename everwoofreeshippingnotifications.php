...
function everwoofreeshippingnotifications_scripts() {
...
add_action( 'wp_enqueue_scripts', 'everwoofreeshippingnotifications_scripts' );
...
function everwoofreeshippingnotifications_settings_init() {
    register_setting('pluginPageEwfsn', 'everwoofreeshippingnotifications_settings');
...
function everwoofreeshippingnotifications_message_before_amount_render() {
    ...
    ?>
    <input type="text" placeholder="ex : Only" name="everwoofreeshippingnotifications_settings[everwoofreeshippingnotifications_message_before_amount]" value="<?php echo $value; ?>">
    <?php
}
/**
...
?>
    <input type="text" placeholder="ex : for free shipping !"name="everwoofreeshippingnotifications_settings[everwoofreeshippingnotifications_message_cart]" value="<?php echo $value; ?>">
<?php
}
...
function everwoofreeshippingnotifications_options_page() {
    ...
    <div class="jumbotron">
        ...
        <ul class="everul">
            ...
            <li>Message is like : Message before amount on checkout page - <strong>Amount calculated </strong>- Message after amount on checkout page</li>
        </ul>
    ...
    <form action='options.php' method='post' id="ewpwPlugin">
        <?php
        settings_fields('pluginPageEwfsn');
        do_settings_sections('pluginPageEwfsn');
        submit_button();
        ?>
    </form>
    <?php
...
//add_filter( 'wc_add_to_cart_message', 'everSetAmountForFreeShippin', 10 );
